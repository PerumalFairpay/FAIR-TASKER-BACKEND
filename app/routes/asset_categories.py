...
@router.post("/", response_model=AssetCategoryResponse, dependencies=[Depends(require_permission("asset:manage"))])
...
@router.put("/{category_id}", response_model=AssetCategoryResponse, dependencies=[Depends(require_permission("asset:manage"))])
...
@router.delete("/{category_id}", dependencies=[Depends(require_permission("asset:manage"))])
